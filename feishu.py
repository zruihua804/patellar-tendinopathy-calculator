...
TABLE_SPECS: tuple[TableSpec, ...] = (
    ...
    TableSpec("assessments", "髌腱病评估表", (text("assessment_id", "评估ID"), text("patient_id", "患者ID"), text("episode_id", "病程ID"), choice("timepoint", "评估节点", "基线", "6周", "12周", "6个月", "12个月"), when("assessment_date", "评估日期"), number("activity_pain_nrs", "指定负荷疼痛NRS"), text("pain_activity_description", "疼痛活动场景"), number("visa_p_total", "VISA-P总分"), choice("visa_p_completion_status", "VISA-P完成状态", "completed", "not completed"), choice("visa_p_respondent_source", "填写来源", "patient", "doctor-assisted", "therapist-assisted", "not completed"), choice("return_to_activity_status", "重返活动状态", "未恢复", "恢复部分活动", "恢复目标运动但未达伤前水平", "恢复伤前水平"), text("warnings", "临床提示"), when("saved_at", "保存时间"))),
    TableSpec("rom", "膝关节活动度表", (text("rom_id", "ROM ID"), text("assessment_id", "评估ID"), choice("joint", "关节", "膝关节", "髋关节", "踝关节"), choice("side", "侧别", "左", "右"), choice("mode", "模式", "主动", "被动"), number("flexion_deg", "屈曲（度）"), number("extension_deficit_deg", "伸展受限（度）"), text("pain_or_limit", "疼痛/限制"), choice("method", "测量方法", "量角器", "倾角仪", "目测", "其他"), text("assessor", "评估者"), when("measured_at", "测量时间"))),
